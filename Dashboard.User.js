...
(function() {
    ...
    console.log("[Bobelle Dashboard] v1.0.55 gestartet");
    ...
    const AAO_TILES_RAW = [
        ...
        { n:"GW-Logistik", id:[108,104], c:C_FW, cat:"FW", s:["ab-l","gw-logistik"]},
    ...
    const DEFAULTS = {
        ...
        footerText:"Design & Optimized by Bobelle 2026", footerColor:"#1e90ff", footerSize:12, footerAlign:"center",
